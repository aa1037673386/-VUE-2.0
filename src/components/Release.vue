<template>
  <div>
    <div class="well-received">
      ...
      <router-link to="/ReleaseAll" class="fr">更多&gt;&gt;</router-link>
    </div>
    <div class="wR">
      <ul>
...
export default {
  ...
  methods: {
    http () {
      var _this = this;
      // https://bird.ioliu.cn/v1?url=http://api.douban.com/v2/movie/coming_soon?start=0&count=10
      this.$http.get('https://bird.ioliu.cn/v1?url=http://api.douban.com/v2/movie/coming_soon?start=0&count=10')
